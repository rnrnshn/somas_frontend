    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            <div>
              <p style={{  fontWeight: 'var(--font-weight-semi-bold)', lineHeight: '1' }}>
        ...
        <Card>
          ...
          <CardContent>
            <div>
              <p style={{  fontWeight: 'var(--font-weight-semi-bold)', lineHeight: '1.2' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span style={{  fontWeight: 'var(--font-weight-semi-bold)', color: 'var(--success)' }}>
                    98.2%
                  </span>
                </div>
                <p style={{  color: 'var(--muted-foreground)' }}>
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span style={{  fontWeight: 'var(--font-weight-semi-bold)', color: 'var(--primary)' }}>
                    4.3 hours
                  </span>
                </div>
                <p style={{  color: 'var(--muted-foreground)' }}>
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span style={{  fontWeight: 'var(--font-weight-semi-bold)', color: 'var(--accent)' }}>
                    9:00 AM
                  </span>
                </div>
                <p style={{  color: 'var(--muted-foreground)' }}>
