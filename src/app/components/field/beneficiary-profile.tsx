...
export function BeneficiaryProfile() {
  ...
  if (query.isPending) {
    return <div className="p-6 pb-24"><Card><CardContent className="p-8 text-center"><p style={{  color: 'var(--muted-foreground)' }}>{t('fieldBeneficiaryPage.loadingRecord')}</p></CardContent></Card></div>;
  }

  if (query.error || !query.data) {
    return <div className="p-6 pb-24"><Card><CardContent className="p-8 text-center"><p style={{  color: 'var(--error)' }}>{query.error instanceof Error ? query.error.message : t('fieldBeneficiaryPage.loadError')}</p></CardContent></Card></div>;
  }
  ...
  return (
    <div className="p-6 pb-24">
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle>{t('fieldBeneficiaryPage.personalInformation')}</CardTitle>
        </CardHeader>
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle>{t('fieldBeneficiaryPage.programDetails')}</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            <p style={{  color: 'var(--muted-foreground)' }}>
          ...
          <div className="pt-3 border-t border-border">
            ...
            <p style={{  fontWeight: 'var(--font-weight-semi-bold)', color: 'var(--accent)' }}>
      ...
      <Card>
        <CardHeader>
          <CardTitle>{t('fieldBeneficiaryPage.verificationAction')}</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
